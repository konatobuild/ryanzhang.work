...
import { initGridexHeroStage } from "./initGridexHeroStage";
import "./gridex-hero.css";

interface GridexHeroStageProps {
  scale?: number;
}

export default function GridexHeroStage({ scale = 1 }: GridexHeroStageProps) {
  const stageRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    if (!stageRef.current) return;
    const teardown = initGridexHeroStage(stageRef.current);
    return teardown;
  }, []);

  return (
    <div className="gridex-stage">
      <div
      ...
      >
        {/* Workspace: 4 functional areas, each with its own form & cursor specialty.
            Layout is intentionally non-grid — slight rotations, varied sizes,
            organic placement to feel like a real desk, not a Kanban board. */}

        {/* INBOX (top-left, narrow, slight CCW tilt) */}
        <div className="ws-card ws-inbox" data-zone="inbox">
          ...
          <ul className="ws-inbox-list">
            <li className="ws-email" data-email="0">
        ...
        {/* COMPOSING email (largest card, lightly tilted right) */}
        <div className="ws-card ws-compose" data-zone="compose" data-tilt="0.6">
          <div className="ws-card-bar ws-card-bar--light">
            <button className="ws-close" aria-hidden="true" tabIndex={-1}></button>
        ...
        {/* SLACK PAIR — beta's swap partner with the email pair.
            Two visually-independent cards (channels rail + chat pane)
            that animate together with a small stagger so they read as a
            coordinated unit. */}
        <div className="ws-card ws-slack-channels" data-zone="slack-channels">
          ...
          <ul className="ws-slack-channel-list">
            <li className="ws-slack-channel is-active" data-ch="brown-matter">
              ...
              <span className="ws-slack-active-dot"></span>
            </li>
        ...
        {/* VOICE TRANSCRIPT — gamma's persistent card. */}
        <div className="ws-card ws-voice" data-zone="voice" data-tilt="-0.7">
          ...
          <div className="ws-voice-waveform" aria-hidden="true">
            <span className="ws-voice-bar"></span>
            <span className="ws-voice-bar"></span>
            <span className="ws-voice-bar"></span>
            <span className="ws-voice-bar"></span>
            <span className="ws-voice-bar"></span>
          ...
          <ul className="ws-voice-transcript" aria-live="polite"></ul>
          <div className="ws-voice-rail-bar">action items</div>
          <ul className="ws-voice-rail"></ul>
        </div>

        {/* CRM contact — gamma's swap partner with voice. */}
        <div className="ws-card ws-crm" data-zone="crm" data-tilt="-0.4">
          ...
          <div className="ws-crm-fields">
            <div className="ws-crm-field" data-field="status">
              ...
              <span className="ws-crm-value">Active</span>
              <ul className="ws-crm-dropdown" aria-hidden="true">
                <li>Active</li>
                <li>Renewal in progress</li>
                <li>On hold</li>
                <li>Closed</li>
              </ul>
            </div>
        ...
        {/* CONTRACT document (bottom, wide, paper-like). */}
        <div className="ws-card ws-contract" data-zone="contract" data-tilt="0.5">
          ...
          <div className="ws-contract-body">
            ...
            <p className="ws-clause ws-clause--target" data-clause="4.2">
          ...
          <div className="ws-margin-note">verify 2024 cap — see Sched B</div>
        </div>

        {/* DOC variant — shares slot with .ws-contract. */}
        <div
          className="ws-card ws-doc"
          data-zone="contract"
          data-tilt="-0.4"
          style={{ display: "none" }}
        >
          ...
          <div className="ws-doc-body">
            ...
            <p className="ws-doc-para ws-doc-para--target">
              <span className="ws-doc-typed"></span>
          ...
          <ul className="ws-doc-sidebar">
            <li className="ws-doc-sugg" data-sugg="1">✦ Add concrete throughput #</li>
            <li className="ws-doc-sugg" data-sugg="2">✦ Cite Q3 cycle-time figure</li>
            <li className="ws-doc-sugg" data-sugg="3">✦ Note SOC2 boundary</li>
            <li className="ws-doc-sugg" data-sugg="4">✦ Link to §2 disclosure</li>
          </ul>
        </div>

        {/* SPREADSHEET — third variant for the bottom-wide slot. */}
        <div
          className="ws-card ws-spreadsheet"
          data-zone="contract"
          data-tilt="-0.3"
          style={{ display: "none" }}
        >
          ...
          <div className="ws-sheet-formula-bar">
            ...
            <span className="ws-sheet-fval"></span>
          </div>
          <div className="ws-sheet-body">
            <table className="ws-sheet-table">
              <thead>
                <tr>
                  <th className="ws-sheet-row-head"></th>
              ...
              <tbody>
                <tr data-sheet-row="0">
                  ...
                  <td className="ws-sheet-actual"></td>
                  <td className="ws-sheet-delta"></td>
                  <td className="ws-sheet-note"></td>
                </tr>
                <tr data-sheet-row="1">
                  <th>2</th>
                ...
                <tr className="ws-sheet-total-row">
                  ...
                  <td className="ws-sheet-total"></td>
                  <td></td>
                  <td></td>
                </tr>
              </tbody>
        ...
        <div className="ws-done-pile" data-zone="done">
          ...
          <ul className="ws-done-log" aria-live="polite">
            <li className="ws-done-row ws-done-row--gamma">
              <span className="ws-done-dot ws-done-dot--gamma"></span>
            ...
            <li className="ws-done-row ws-done-row--beta">
              <span className="ws-done-dot ws-done-dot--beta"></span>
            ...
            <li className="ws-done-row ws-done-row--alpha">
              <span className="ws-done-dot ws-done-dot--alpha"></span>
